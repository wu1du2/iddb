...
create table publisher_2(pid int primary key, pname char(100), nation char(3));
drop table if exists book_2;
create table book_2(bid int primary key, title char(100), authors char(200), bpid int, copies int);
