...
create table publisher_1(pid int primary key, pname char(100), nation char(3));
drop table if exists book_1;
create table book_1(bid int primary key, title char(100), authors char(200), bpid int, copies int);
drop table if exists customer_1;
create table customer_1(cid int primary key, rank int);
