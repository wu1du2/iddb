...
create table publisher_0(pid int primary key, pname char(100), nation char(3));
drop table if exists book_0;
create table book_0(bid int primary key, title char(100), authors char(200), bpid int, copies int);
drop table if exists customer_0;
create table customer_0(cid int primary key, cname char(25));
